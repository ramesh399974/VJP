...
import { RadioExamReportComponent } from './sheets/rt-inspection/radio-exam-report/radio-exam-report.component';
import { CalibrationReportComponent } from './sheets/rt-inspection/calibration-report/calibration-report.component';
import { PeriodicCalibrationReportComponent } from './sheets/rt-inspection/periodic-calibration-report/periodic-calibration-report.component';
import { DeveloperTemperatureReportComponent } from './sheets/rt-inspection/developer-temperature-report/developer-temperature-report.component';
import { XRayProcessingReportComponent } from './sheets/rt-inspection/x-ray-processing-report/x-ray-processing-report.component';
import { RtTrainingReportComponent } from './sheets/rt-inspection/rt-training-report/rt-training-report.component';
import { RtLogbookReportComponent } from './sheets/rt-inspection/rt-logbook-report/rt-logbook-report.component';
import { CastingFinalInspectionComponent } from './sheets/casting-final-inspection/casting-final-inspection.component';
import { FpiInspectionComponent } from './sheets/fpi-inspection/fpi-inspection.component';
import { ShotBlastComponent } from './sheets/shot-blast/shot-blast.component';
import { HeatTreatmentT6Component } from './sheets/heat-treatment-t6/heat-treatment-t6.component';
import { InprocessInspectionComponent } from './sheets/pouring/inprocess-inspection/inprocess-inspection.component';
import { PatrolInspectionComponent } from './sheets/pouring/patrol-inspection/patrol-inspection.component';
import { InwardInspectionComponent } from './sheets/incoming-inpection/inward-inpection/inward-inspection.component';
import { IngotFractureComponent } from './sheets/incoming-inpection/ingot-fracture/ingot-fracture.component';
import { MetalChargingComponent } from './sheets/metal-charging/metal-charging.component';
import { MetalTreatmentComponent } from './sheets/metal-treatment/metal-treatment.component';
import { MoltenMetalComponent } from './sheets/molten-metal/molten-metal.component';
import { CastingFirstComponent } from './sheets/pouring/casting-first/casting-first.component';
import { DieStartupComponent } from './sheets/pouring/die-startup/die-startup.component';
...
@NgModule({
  declarations: [
    ...
    ProductcharacteristicsComponent,
    ProcesscharacteristicsComponent,
    RadioExamReportComponent,
    CalibrationReportComponent,
    PeriodicCalibrationReportComponent,
    DeveloperTemperatureReportComponent,
    XRayProcessingReportComponent,
    RtTrainingReportComponent,
    RtLogbookReportComponent,
    CastingFinalInspectionComponent,
    FpiInspectionComponent,
    ShotBlastComponent,
    HeatTreatmentT6Component,
    InprocessInspectionComponent,
    PatrolInspectionComponent,
    InwardInspectionComponent,
    IngotFractureComponent,
    MetalChargingComponent,
    MetalTreatmentComponent,
    MoltenMetalComponent,
    CastingFirstComponent,
    DieStartupComponent,
